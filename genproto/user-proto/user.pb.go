...
type UploadMediaRequest struct {
	UserId               string   `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id"`
	MediaData            []byte   `protobuf:"bytes,2,opt,name=media_data,json=mediaData,proto3" json:"media_data"`
	FileExtension        string   `protobuf:"bytes,3,opt,name=file_extension,json=fileExtension,proto3" json:"file_extension"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *UploadMediaRequest) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *UploadMediaRequest) GetMediaData() []byte {
	if m != nil {
		return m.MediaData
	}
	return nil
...
func (m *UploadMediaRequest) GetFileExtension() string {
	if m != nil {
...
type UploadMediaResponse struct {
	MediaUrl             string   `protobuf:"bytes,1,opt,name=media_url,json=mediaUrl,proto3" json:"media_url"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*UploadMediaResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3685497d3bcbbc58, []int{12}
}
...
func (m *UploadMediaResponse) GetMediaUrl() string {
	if m != nil {
		return m.MediaUrl
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*UploadMediaRequest)(nil), "user.UploadMediaRequest")
	proto.RegisterType((*UploadMediaResponse)(nil), "user.UploadMediaResponse")
}
...
var fileDescriptor_3685497d3bcbbc58 = []byte{
	...
	,
}
...
func (c *mediaServiceClient) UploadMedia(ctx context.Context, in *UploadMediaRequest, opts ...grpc.CallOption) (*UploadMediaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.MediaService/UploadMedia", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMediaServiceServer) UploadMedia(ctx context.Context, req *UploadMediaRequest) (*UploadMediaResponse, error) {
...
func _MediaService_UploadMedia_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.MediaService/UploadMedia",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *UploadMediaRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FileExtension) > 0 {
		...
		i = encodeVarintUser(dAtA, i, uint64(len(m.FileExtension)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.MediaData) > 0 {
		...
		i = encodeVarintUser(dAtA, i, uint64(len(m.MediaData)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.UserId) > 0 {
...
func (m *UploadMediaResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MediaUrl) > 0 {
		...
		i = encodeVarintUser(dAtA, i, uint64(len(m.MediaUrl)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
